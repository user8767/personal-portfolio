    ...
    >
      <div className="flex items-center justify-center">
        <div className="relative">
          ...
          >
            <Image
              src="https://media.licdn.com/dms/image/D4D03AQEzOrMl0O1EVw/profile-displayphoto-shrink_400_400/0/1706102390947?e=1711584000&v=beta&t=tCnhRBaiHIWOCgWTwjszjie7G4sZVE5onjCNMNzSreY"
              alt="Pratik portrait"
              width="192"
              height="192"
              quality="95"
      ...
      >
        ...
        <a
          ...
          href="https://github.com/user8767"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
        <a
          className="bg-white p-4 text-gray-700 flex items-center gap-2  rounded-full focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60"
          href="https://twitter.com/user_4342"
          target="_blank"
        >
          <FaTwitterSquare />
        </a>
